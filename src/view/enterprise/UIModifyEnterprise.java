 ...
 */
public class UIModifyEnterprise extends javax.swing.JFrame {
	...
	public void setOldEnterpriseName(String oldEnterpriseName) {
		this.oldEnterpriseName = oldEnterpriseName;
	}
		...
		try {
			if (name.equals("") || desc.equals("") || email.equals("")) {
				...
				EnterpriseController controller = new EnterpriseController(
						name, desc, email);
				controller.updateEnterprise(oldEnterpriseName);
